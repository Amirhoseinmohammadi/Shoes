    ...
    return (
      <div className="mx-auto max-w-4xl p-6">
        <div className="rounded-2xl bg-white p-8 text-center shadow-lg">
          <div className="text-gray-500">در حال بارگذاری محصول...</div>
        </div>
      </div>
    );
        ...
        <form onSubmit={handleSave} className="flex flex-col gap-8">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 py-4 text-lg font-semibold text-white shadow-lg transition-all hover:from-blue-700 hover:to-blue-800 disabled:opacity-50"
            >
            ...
            <button
              ...
              className="rounded-xl bg-gradient-to-r from-red-600 to-red-700 px-8 py-4 text-lg font-semibold text-white shadow-lg transition-all hover:from-red-700 hover:to-red-800"
            >
              🗑️ حذف محصول
            </button>
          </div>
