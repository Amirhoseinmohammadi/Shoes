        ...
        <div className="border-body-color/[.15] border-b pb-16 md:pb-20 lg:pb-28 dark:border-white/[.15]">
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
              <SectionTitle
                title="ونس پاندا پاموک - نرم، بادوام و سبک"
                paragraph=""
                mb="44px"
              />
              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="طراحی: کتانی مدل ونس پاندا با رنگ اصلی سفید و خطوط مشکی روی کناره‌ها" />
                    <List text="زیره: زیره پهن و ضخیم از جنس PU با دوام و سبک" />
                    <List text="سایز: این مدل در سایزهای ۳۲ تا ۳۶ موجود است." />
                  </div>
                </div>
              </div>
            </div>
