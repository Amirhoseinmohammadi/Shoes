...
export default function SingleShoe({ shoe, telegramUser }: SingleShoeProps) {
  ...
  if (!shoe?.id) {
    return (
      <div className="group overflow-hidden bg-white shadow-sm dark:bg-gray-800">
  ...
  return (
    <div className="group l relative overflow-hidden bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl dark:bg-gray-800 dark:hover:shadow-gray-700/50">
      <div className="relative aspect-square overflow-hidden bg-gradient-to-br from-gray-100 to-gray-50 dark:from-gray-700 dark:to-gray-600">
        <Image
      ...
      <div className="p-4">
        <h3 className="mb-2 line-clamp-2 text-sm font-bold text-gray-900 transition-colors group-hover:text-cyan-600 dark:text-white dark:group-hover:text-cyan-400">
        ...
        <div className="flex gap-1.5">
          <button
            ...
            disabled={loading}
            className="flex flex-1 items-center justify-center gap-1.5 rounded-lg bg-cyan-500 px-3 py-2 text-sm font-medium text-white transition-all duration-200 hover:bg-cyan-600 active:scale-95 disabled:opacity-50 dark:bg-cyan-600 dark:hover:bg-cyan-700"
          >
            {loading ? (
      ...
      <div className="pointer-events-none absolute inset-0 rounded-2xl border-2 border-cyan-500 opacity-0 transition-opacity duration-300 group-hover:opacity-10 dark:border-cyan-400"></div>
    </div>
  );
}
